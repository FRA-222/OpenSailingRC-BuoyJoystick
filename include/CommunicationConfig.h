...
enum class CommMode {
    ...
    LORA_433    ///< LoRa communication, 433 MHz module (E220-400T22D)
};
...
public:
     ...
     * radio channel: use this for everything common, and an explicit test on
     * LORA_920 / LORA_433 only where the band actually matters.
     *
